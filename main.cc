...
void test_make_list() {
  ...
  wm::print_tuple<wm::flat_tree<node>>{}();
}
...
void test_algorithm() {
  ...
  wm::print_tuple<wm::list2tuple<great>>{}();
  wm::print_tuple<wm::list2tuple<less>>{}();
}
...
void test_sort() {
  ...
  wm::print_tuple<wm::list2tuple<ret>>{}();
