...
namespace wm {
struct EmptyList;
template <class T> struct is_empty_list : std::false_type {};
template <> struct is_empty_list<EmptyList> : std::true_type {};
template <class T>
inline constexpr bool is_empty_list_v = is_empty_list<T>::value;
